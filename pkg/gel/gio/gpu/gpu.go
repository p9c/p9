...
import (
	...
	// Register backends.
	_ "github.com/p9c/p9/pkg/gel/gio/gpu/internal/d3d11"
	_ "github.com/p9c/p9/pkg/gel/gio/gpu/internal/opengl"
)
...
loop:
	for encOp, ok := r.Decode(); ok; encOp, ok = r.Decode() {
		...
		case opconst.TypePaint:
			...
			z++
			if z != int(uint16(z)) {
				// TODO(eliasnaur) github.com/p9c/p9/pkg/gel/gio/issue/127.
