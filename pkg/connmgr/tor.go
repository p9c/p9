...
// TorLookupIP uses Tor to resolve DNS via the SOCKS extension they provide for resolution over the Tor network. Tor
// itself doesn't support ipv6 so this doesn't either.
